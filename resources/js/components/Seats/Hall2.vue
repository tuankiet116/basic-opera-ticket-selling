<template>
    <div class="mt-5 row justify-content-center w-100 m-0">
        <div id="rows" class="container-md overflow-x-auto container-fluid h-100" ref="rows">
            <div id="seats-container" ref="seatsContainer" class="row p-0 justify-content-center mt-5 seats-container mx-auto" style="width: 1250px;">
                <div v-for="row in rows1" class="row mt-2 justify-content-center flex-nowrap" :style="`height: ${caculateRowHeight(row)}px`">
                    <template v-for="seat in row">
                        ...
                        <div v-else class="seat" :style="`margin-top: ${seat.marginTop}px !important; width: ${seat.width}px; height: ${seat.height}px;`"/>
                    </template>
                </div>
                <div class="row p-0 justify-content-center flex-nowrap my-2" style="width: 1050px;">
                    ...
                    <div v-for="row in rows2" class="row mt-2 justify-content-center flex-nowrap" :style="`height: ${caculateRowHeight(row)}px`">
                        <template v-for="seat in row">
                            <div v-if="seat.id"
                                class="border border-dark seat d-flex justify-content-center align-items-center"
                                :style="`margin-top: ${seat.marginTop}px !important; width: ${seat.width}px; height: ${seat.height}px;`">
                ...
                <div v-for="row in rows3" class="row mt-2 justify-content-center flex-nowrap" :style="`height: ${caculateRowHeight(row)}px`">
                    <template v-for="seat in row">
                        <div v-if="seat.id"
                            class="border border-dark seat d-flex justify-content-center align-items-center"
                            :style="`margin-top: ${seat.marginTop}px !important; width: ${seat.width}px; height: ${seat.height}px;`">
