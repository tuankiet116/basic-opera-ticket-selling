        ...
        <div class="container-fluid py-2 d-flex row">
            ...
            <div class="col p-0 d-flex align-items-center justify-content-end">
                <div class="d-flex align-items-center">
                    ...
                    <select v-model="lang" class="form-select form-select-sm ms-2" @change="changeLanguage">
...
let lang = ref();
let i18n = useI18n({ useScope: "global" });
const changeLanguage = async () => {
    i18n.locale.value = lang.value;
    localStorage.setItem("hgo-lang", lang.value);
}

onMounted(() => {
    let currentLang = localStorage.getItem("hgo-lang");
    if (currentLang == "vi" || currentLang == "en") lang.value = currentLang;
    else lang.value = window.navigator.language.includes("vi") ? "vi" : "en"
    localStorage.setItem("hgo-lang", lang.value);
    i18n.locale.value = lang.value;
})
</script>