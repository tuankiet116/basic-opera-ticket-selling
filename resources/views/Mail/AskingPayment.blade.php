<div>
  ...
  <p dir="ltr">
    <em>
      To complete your ticket purchase for the {{ $event->name }} {{ date('F j, Y', strtotime($event->date)) }}, please
      transfer the
  ...
  <p dir="ltr"> </p>
  <p dir="ltr"><strong>Lưu ý: </strong>Ghế sẽ được TẠM GIỮ khi bạn gửi form và chỉ được XÁC NHẬN khi bạn thanh toán
    TRONG VÒNG 15 PHÚT sau khi nhận được email này. Sau 15 phút, nếu BTC chưa nhận được thanh toán, ghế sẽ quay trở lại
    trạng thái còn trống.</p>
  <p dir="ltr"><em><strong>NOTES: </strong>Seats will only be CONFIRMED once we receive the bank transfer WITHIN 15
      MINUTES after you receive this email. After 15 minutes, your booked seats will be available on the seat map
      again.</em></p>
  <p dir="ltr"> </p>
  <p dir="ltr">- Sau khi chuyển khoản thành công, phản hồi lại email này kèm ảnh màn hình giao dịch thành công. Thư
    xác nhận thanh toán sẽ được gửi về email của bạn trong vòng 24h.</p>
  <p dir="ltr"><em>- After successful transfer, reply to this email with your successful transaction screenshot.
      Payment confirmation invoice will be sent to your email within 24 hours.</em></p>
  <p dir="ltr"> </p>
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <a href="https://www.google.com/maps/search/40-40A+Hang+Bai?entry=gmail&amp;source=g" target="_blank"
            rel="noopener">
          ...
          <p dir="ltr">
            <a href="mailto:live.hoguomopera@gmail.com" target="_blank" rel="noopener">live.hoguomopera@gmail.com</a>
          </p>
          <p dir="ltr">
